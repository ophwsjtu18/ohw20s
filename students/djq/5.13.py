#a version from a outstanding student
import vtk
...
STLComponent.SetProperty(color = [1, 1, 1], diffuse = 1,specular = 0.4, specularPower = 20)


STLName = ['arm.stl','arm_motor_base.stl','arming_arm.stl','base.stl','base_motor_mount.stl','controller_bottom.stl','controller_top.stl','plate.stl','tray.stl','tray_gate.stl']
STLPart = []
